<x-layout>
    ...
    <div class="w3-container w3-white w3-card  w3-content" style="max-width: 900px; margin-top: 80px;">
        <h2  class="w3-text-theme w3-center">Update your interest   </h2>
        ...
        <div class="w3-container" >
            <form action="{{ route('interests.update', $interest) }}" method="POST"  >
                ...
                <div >
                    <input type="submit" class="w3-button w3-theme w3-margin-top" value="Update interest"></input>
                        <br>
                </div>
